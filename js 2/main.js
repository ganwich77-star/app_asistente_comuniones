...
let giftSettingsData = { iban: "", bizumPhone: "", beneficiary: "", bankName: "", menuVisible: true, attendanceVisible: true };
    ...
    onSnapshot(doc(db, 'eventos', EVENT_ID, 'settings', 'configuracion'), snap => {
        if (snap.exists()) {
            ...
            if (regaloSection) {
                ...
                console.log("🎁 Estado de Regalo:", { hasGiftOptions, iban: c.ibanVisible, bizum: c.bizumVisible });
