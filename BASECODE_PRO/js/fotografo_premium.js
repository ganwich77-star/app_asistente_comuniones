...
if (btnLoginSubmit) {
    btnLoginSubmit.addEventListener('click', async () => {
        ...
        if ((userRaw.toLowerCase() === 'admin' || userRaw.toLowerCase() === 'basecode') && pass === '11111111') {
            return unlockPanel('basecode', true);
        }
...
function renderEventsGrid(events) {
    ...
    events.forEach(event => {
        const covPhoto1 = event.introFoto1 || event.foto1 || 'assets/images/logo basecode.png';
        const covPhoto2 = event.introFoto2 || event.foto2 || 'assets/images/logo basecode.png';
        const covPhoto3 = event.introFoto3 || event.foto3 || 'assets/images/logo basecode.png';
                ...
                <div class="bg-card-dark border border-primary/20 rounded-3xl p-4 hover:border-primary/50 transition-all flex items-center justify-between group w-full gap-4 relative overflow-hidden">
                    ...
                    <div class="bg-black border border-primary/30 rounded-xl p-3 shrink-0 lg:w-[420px] flex flex-col justify-center">
                        ...
                        <div class="flex items-center gap-2">
                            <input type="text" readonly value="https://basecode.es/mi_primera_comunion/index.html?id=${event.id}" 
                            ...
                            <button type="button" onclick="window.copyToClipboardPremium('https://basecode.es/mi_primera_comunion/index.html?id=${event.id}', this)" class="text-primary hover:text-primary/70 transition-colors bg-[#1A1810] p-1.5 rounded-lg border border-primary/20 shrink-0">
                ...
                <div class="bg-card-dark border border-primary/20 rounded-3xl p-5 hover:border-primary/50 transition-all flex flex-col justify-between group relative w-full h-full min-h-[350px]">
                    ...
                    <div class="bg-black border border-primary/30 rounded-xl p-4 mt-auto">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <button type="button" onclick="window.copyToClipboardPremium('https://basecode.es/mi_primera_comunion/index.html?id=${event.id}', this)" class="text-primary hover:text-primary/70 transition-colors bg-[#1A1810] p-2.5 rounded-lg border border-primary/20 shrink-0 flex items-center justify-center hover:bg-primary/20">
...
window.sendWAPanel = (eventId) => {
    ...
    const cleanUrl = `https://basecode.es/mi_primera_comunion/index.html?id=${eventId}`;
